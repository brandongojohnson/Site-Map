...
const FinalCTA = ({ onGetStarted }) => (
  <section className="py-20 md:py-28 px-4 sm:px-6 border-t border-white/10 bg-[#131313]">
    <div className="relative max-w-6xl mx-auto rounded-[28px] overflow-hidden bg-white/[0.03] border border-white/10 px-8 py-24 md:py-32 text-center">
      ...
      <div className="relative">
        <p className="text-[12px] font-semibold uppercase tracking-widest text-[#9B8FF5] mb-6">
          Get started
        </p>
        <h2 className="text-[32px] md:text-[48px] font-bold tracking-tight text-[#F5F3F0] leading-tight max-w-2xl mx-auto mb-6">
          Turn user research into clear structure.
        </h2>
        <p className="text-[16px] md:text-[18px] font-normal text-white/60 max-w-lg mx-auto mb-10">
