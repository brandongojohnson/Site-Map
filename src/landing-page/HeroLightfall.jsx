...
import './HeroLightfall.css';

// Falling light-streak shader, adapted from reactbits.dev's Lightfall
// background (https://reactbits.dev/backgrounds/lightfall). Used as the
// hero background in dark mode only — light mode keeps the flat off-white
// default.
...
const HeroLightfall = ({
  ...
  useEffect(() => {
    ...
    const effectiveMouseInteraction = mouseInteraction && !reducedMotion;
  ...
  return <div ref={containerRef} className={`hero-lightfall ${className ?? ''}`} />;
};

export default HeroLightfall;
