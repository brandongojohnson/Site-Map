...
const Testimonial = () => (
  <section className="relative py-24 md:py-32 border-t border-white/10 bg-[#131313]">
    <div className="max-w-3xl mx-auto px-6 text-center">
      <p className="text-[12px] font-semibold uppercase tracking-widest text-[#9B8FF5] mb-8">
        Social proof
      </p>
      <blockquote className="text-[22px] md:text-[28px] font-semibold tracking-tight text-[#F5F3F0] leading-snug mb-8">
      ...
      <p className="text-[14px] font-normal text-white/50">Early access pilot, UX research team</p>
    </div>
  </section>
);
